...
const GENERATE_TITLE_PROMPT = (userMessage: string) => `Based on the following user message, generate a concise, descriptive title for this conversation. The title should be:
